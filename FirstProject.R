# Exploratory Data Analysis, Week 1 Programming Assignment by Karen Enfield
...
# Plot 1
hist(dfFeb0102$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
# Plot 2
a<-plot(dfFeb0102$Time, dfFeb0102$Global_active_power,ylab="Global Active Power (kilowatts)", type="l", xlab="")
